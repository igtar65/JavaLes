...
public class Array_Sort {
    ...
    public static void main(String[] args) {
        ...
        for (int i = myArr2.length - 1; i > 0; i--) {
         ...
         int tmp = myArr2[j];           // -tmp -заводим временную переменную-куда складываем результат сравнения
         myArr2[j] = myArr2[j + 1];
         myArr2[j + 1] = tmp;            //-по оканчании цикла (длинна массива)-результат сортировки из tmp - возвращаем а Arr2                
