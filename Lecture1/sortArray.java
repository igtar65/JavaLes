 ...
 * проходим по очереди (по индексам) - myArr
 * или с циклом for (i) Сравнивать каждый элемент со следующим ([0] с [1], [1] с [2], [2] с [3] и т.д.). (i,j )Если текущий элемент массива больше
